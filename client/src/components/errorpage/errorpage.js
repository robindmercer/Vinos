  ...
  return (
    <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
      <div className="w-full lg:w-1/2">    
                 {/* <img className="hidden md:block lg:hidden" src="https://www.casadevinosmendoza.com.ar/wp-content/uploads/2022/04/promo-4-500x500.jpg" alt="" />  */}
        <img className="md:hidden" src="" alt={imgVino} />
      </div>
      <div className="w-full lg:w-1/2">
        <h1 className="py-4 text-3xl lg:text-4xl font-extrabold text-gray-800">
          {msj ? msj :'No se han encontrados los productos solicitados'} 
        </h1>
        <button 
