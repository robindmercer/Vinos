  ...
  return (
    <div>
      <div className="lg:block hidden">
        ...
        {suscripto && (
          <Fragment>
            <p className="text-sm text-green-500">Te suscribiste con exito!</p>
            </Fragment>
        )}
        {vacio && (
          <p className="text-sm text-red-500">Debe ingresar un email</p>
        )}
        {valido && (
          <p className="text-sm text-red-500">Ingrese un mail valido</p>
        )}
      </div>
